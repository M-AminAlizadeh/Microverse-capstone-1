...
# 📖 [Capstone project of Microverse] <a name="about-project"></a>

> This project is about international judo summit with 2 pages (home,about)
...
- [Live Demo Link](https://m-aminalizadeh.github.io/Microverse-capstone-1/)
...
```sh
git clone https://github.com/M-AminAlizadeh/Microverse-capstone-1.git
```

then you will see the **Microverse-capstone-1** on your system then type this:
...
Inside **Microverse-capstone-1** you can see `index.html` file double click it
...
Feel free to check the [issues page](https://github.com/M-AminAlizadeh/Microverse-capstone-1/issues).
